...
import CreateGenere from "./features/genres/components/CreateGenere";
...
import HandleRouteNotFound from "./features/home/components/HanldeRouteNotFound";
...
export default function AppRoutes() {
	return (
		<Routes>
			...
			<Route path="/genres/create" element={<CreateGenere />} />
