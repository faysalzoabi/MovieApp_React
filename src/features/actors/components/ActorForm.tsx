...
export default function ActorForm(props: ActorFormProps) {
	...
	const currentImageURL: string | undefined = props.model?.picture
		? (props.model.picture as string)
		: undefined;

	console.log("heyyy", currentImageURL);
		...
		<>
			<form onSubmit={handleSubmit(props.onSubmit)}>
				...
				<div className="mt-2">
					...
					<NavLink to="/actors" className="btn btn-secondary ms-2">
						Cancel
					</NavLink>
				</div>
			</form>
